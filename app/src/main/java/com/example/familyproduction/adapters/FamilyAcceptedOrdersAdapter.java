...
public class FamilyAcceptedOrdersAdapter extends RecyclerView.Adapter<FamilyAcceptedOrdersAdapter.ViewHolder>{

    Context context;
    private ArrayList<Order> items;


    public FamilyAcceptedOrdersAdapter(Context context, ArrayList<Order> items) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.accepted_order_list_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.acceptBtn.setOnClickListener(v -> {
            updateOrder(item.getId(), position, Constants.ORDER_STATUS_DONE);
        });
