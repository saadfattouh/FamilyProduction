...
public class CustomerMealsAdapter extends RecyclerView.Adapter<CustomerMealsAdapter.ViewHolder>{

    Context context;
    private ArrayList<Food> items;


    public CustomerMealsAdapter(Context context, ArrayList<Food> items) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            foodDetails.putExtra("owner_id", item.getOwnerId());
